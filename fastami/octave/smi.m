% The code was taken from this paper:
...
% The code was published online alongside the aforementioned paper, here https://sites.google.com/site/icml2014smi/SMI.zip.
%
...
function [SMI_]=smi(true_mem,mem)
  ...
  NijLogNij=(1:maxNij).*log(1:maxNij);
  NijLogNij = [0 NijLogNij]; % 0log0 added
  x = -(a(a ~= 0))*log(a(a ~= 0))' - (b(b ~= 0))*log(b(b ~= 0))' + N*log(N);
